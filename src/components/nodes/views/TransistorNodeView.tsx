...
interface TransistorNodeViewProps {
  component: CircuitComponent
}

const TransistorNodeView: FC<TransistorNodeViewProps> = ({ component }) => {
  return (
    <div className="flex items-center space-x-3">
      <div className="w-3 h-3 bg-gray-400 rounded-full border-2 border-gray-600"></div>

      <div className="text-blue-600">
        <GoGitCommit className="text-teal-400" size={24} />
      </div>
...
export default TransistorNodeView

...
interface VoltageSourceACNodeViewProps {
  component: CircuitComponent
}

const VoltageSourceACNodeView: FC<VoltageSourceACNodeViewProps> = ({
  component,
}) => {
  return (
    <div className="flex items-center space-x-3">
      ...
      <div className="text-blue-600">
        <IoSwapVerticalOutline className="text-purple-400" size={24} />
      </div>
...
export default VoltageSourceACNodeView

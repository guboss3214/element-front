...
interface VoltageSourceDCNodeViewProps {
  component: CircuitComponent
}

const VoltageSourceDCNodeView: FC<VoltageSourceDCNodeViewProps> = ({
  component,
}) => {
  return (
    <div className="flex items-center space-x-3">
      ...
      <div className="text-blue-600">
        <IoBatteryFullOutline className="text-red-400" size={24} />
      </div>
...
export default VoltageSourceDCNodeView
